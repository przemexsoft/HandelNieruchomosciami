        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.NieruchomoscTypZabudowy,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TransakcjaUmowaId = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "Nieruchomoscs",
                column: "NieruchomoscTypZabudowy");

            migrationBuilder.CreateIndex(
                name: "IX_Transakcjas_AgentId",
                table: "Transakcjas",
                column: "TransakcjaAgentId");

            migrationBuilder.CreateIndex(
                name: "IX_Transakcjas_KontrahentId",
                table: "Transakcjas",
                column: "TransakcjaKontrahentId");

            migrationBuilder.CreateIndex(
                name: "IX_Transakcjas_NieruchomoscId",
                table: "Transakcjas",
                column: "TransakcjaNieruchomoscId");

            migrationBuilder.CreateIndex(
                name: "IX_Transakcjas_StatusTransakcjiId",
                table: "Transakcjas",
                column: "TransakcjaStatusTransakcjiId");

            migrationBuilder.CreateIndex(
                name: "IX_Transakcjas_UmowaId",
                table: "Transakcjas",
                column: "TransakcjaUmowaId");

            migrationBuilder.CreateIndex(
                name: "IX_Transakcjas_WlascicielId",
                table: "Transakcjas",
                column: "TransakcjaSprzedawcaId");

            migrationBuilder.CreateIndex(
                name: "IX_Umowas_KontrahentId",
                table: "Umowas",
                column: "UmowaKontrahentId");

            migrationBuilder.CreateIndex(
                name: "IX_Umowas_NieruchomoscId",
                table: "Umowas",
                column: "UmowaNieruchomoscId");

            migrationBuilder.CreateIndex(
                name: "IX_Umowas_WlascicielId",
                table: "Umowas",
                column: "UmowaSprzedajacyId");
        }
